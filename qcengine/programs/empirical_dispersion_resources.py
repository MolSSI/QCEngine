...
dashcoeff = {
    ...
    "d3mzero": {
        ...
        "definitions": {
            ...
            "sapt0": {"params": {"s6": 1.000, "s8":0.88551674, "sr6": 1.38321381, "beta":0.07548827 }},  # JBS 2021
            "hf":    {"params": {"s6": 1.000, "s8":0.88551674, "sr6": 1.38321381, "beta":0.07548827 }},  # JBS 2021
        },
    },
    "d3mbj": {
        "formal": "D3M(BJ)",
        ...
        "definitions": {
            ...
            "sapt0": {"params": {"s6": 1.000, "s8": 0.713190, "a1": 0.079541, "a2": 3.627854}}, # JBS 2021 
            "hf": {"params": {"s6": 1.000, "s8": 0.713190, "a1": 0.079541, "a2": 3.627854}},    # JBS 2021 
        },
    },
    "nl": {
        "formal": "NL",
